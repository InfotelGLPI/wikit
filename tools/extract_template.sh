...
xgettext *.php */*.php --copyright-holder='Wikit Development Team' --package-name='GLPI - Wikit plugin' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
